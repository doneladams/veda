    ...
    getDriver: function (driver) {
        if (process.env.TRAVIS_BUILD_NUMBER === undefined)
        {
            ...
            if (process.env.LOCAL === undefined)
            {
                ...
                //return new webdriver.Builder().usingServer('http://127.0.0.1:4444/wd/hub').withCapabilities({
                    platform: driver.os,
            ...
            return new webdriver.Builder().usingServer('http://127.0.0.1:4445/wd/hub').withCapabilities({
                platform: driver.os,
                browserName : driver.browser,
                version : driver.version,
                'screenResolution' : '1280x960',
