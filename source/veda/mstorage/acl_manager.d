                       ...
                       KeyValueDB storage)
{
    ...
    {
        update_right_set(delta_resource, resource, true, useFilter, prefix, access, op_id, storage);
    }

    if (delta_in_set.length > 0)
    {
        update_right_set(delta_in_set, in_set, true, useFilter, prefix, access, op_id, storage);
    }
}
