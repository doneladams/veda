...
void main(string[] args)
{
    ...
    const string uris_queue_path          = "./data/uris";
    ...
    Queue        uris_queue, individuals_queue;

    uris_queue = new Queue(uris_queue_path, "uris-db", Mode.RW, log);
